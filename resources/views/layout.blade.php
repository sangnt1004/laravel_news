...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link type="text/css" rel="stylesheet" href="{{ asset('access/stylesheets/bootstrap.min.css')}}" />
    <!-- Custom CSS -->
    <link type="text/css" rel="stylesheet" href="{{ asset('access/stylesheets/blog-home.css')}}" />
</head>
<body>
    <!-- Navigation -->
    ...
    <!-- jQuery -->
    <script type="text/javascript" src="{{ asset('access/javascripts/jquery.js')}}"></script>
    <!-- Bootstrap Core JavaScript -->
    <script type="text/javascript" src="{{ asset('access/javascripts/bootstrap.min.js')}}"></script>
